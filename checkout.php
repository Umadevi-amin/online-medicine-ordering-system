...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" name="name" class="col-md-4" class="form-control" required="true">
			</div>
		</div>
		<div class="form-group">
			<label for="address" class="control-label col-md-4">Address</label>
			<div class="col-md-4">
				<input type="text" name="address" class="col-md-4" class="form-control" required="true">
			</div>
		</div>
		<div class="form-group">
			<label for="city" class="control-label col-md-4">City</label>
			<div class="col-md-4">
				<input type="text" name="city" class="col-md-4" class="form-control" required="true">
			</div>
		</div>
		<div class="form-group">
			<label for="zip_code" class="control-label col-md-4">Zip Code</label>
			<div class="col-md-4">
				<input type="text" name="zip_code" class="col-md-4" class="form-control" pattern="[0-9]*" required="true" minlength="6" maxlength="6">
			</div>
		</div>
		<div class="form-group">
...
<div class="col-md-4">
            <select id="country" name="country" class="col-md-4" class="form-control" required="true">
	...
	<p class="lead">Please press purchase to confirm your purchase or continue shopping</p>
<?php
	} else {
